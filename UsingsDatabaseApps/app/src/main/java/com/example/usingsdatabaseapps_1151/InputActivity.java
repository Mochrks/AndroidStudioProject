...
// TODO Auto-generated method stub
                ...
                if (edit.isEmpty()) {
                    ...
                    ((SQLiteDatabase) db).execSQL("insert into mahasiswa(nim, nama, tgl, jk, alamat) values('" + text1.getText().toString() + "','" + text2.getText().toString() + "','" + text3.getText().toString() + "','" + text4.getText().toString() + "','" + text5.getText().toString() + "')");
