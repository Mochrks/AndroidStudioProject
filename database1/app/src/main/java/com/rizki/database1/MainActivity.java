...
//Akan dijalankan di tambahan di praktikum selanjutnya
                Intent inte = new Intent(MainActivity.this,
                        InputActivity.class); startActivity(inte);
    ...
    public void RefreshList() {
        ...
        cursor = db.rawQuery("SELECT * FROM mahasiswa",
                null);
...
//.getItemAtPosition(arg2).toString();
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    ...
                    { switch (item) { case 0:
                        // akan memanggil activity detail data break;

                        break;
                        case 1:
                            // akan memanggil activity update data break;
                        case 2:
                            // akan menghapus data
                            break;
                    }
